...
import TabOngoingCreator from './TabOngoingCreator/TabOngoingCreator';
import TabFinishedCreator from './TabFinishedCreator/TabFinishedCreator';
import TabDraftCreator from './TabDraftCreator/TabDraftCreator';
      ...
      <Box className={classes.mainContainer}>
        ...
        >
          ...
          />
                    <Tab
            classes={{ selected: classes.tabSelected, textColorInherit: classes.label, root: classes.tab }}
            label={<TabLabelActivity nom="Draft" total={2} />}
            {...a11yProps(0)}
          />
          <Tab
            classes={{ selected: classes.tabSelected, textColorInherit: classes.label, root: classes.tab }}
